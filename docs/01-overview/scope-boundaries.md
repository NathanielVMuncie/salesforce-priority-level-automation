...
This document defines the explicit scope boundaries of the Céleste Vineyards Lead Priority Level Automation system. It establishes what is included in the build, what is intentionally excluded, and the rationale for each boundary decision.

All documentation, testing, and portfolio materials in this repository are constrained to the scope defined here.
...
- Record-Triggered After-Save Flow — `Lead Scoring and Priority Level Assignment V7`
...
- All phase documentation as defined in the repository Documentation Index
